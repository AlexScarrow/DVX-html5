    ...
    shots = {
        {
            ...
            duration = 24,
            ease = "linear",--"in_out_sine",
            from = { x = 0, y = 0, z=2, scale_x = 10, scale_y = 10, alpha = 1.0 },
            to = { x = 0, y = 0, z=2, scale_x = 10, scale_y = 10, alpha = 1.0 },
            --fx_cues = {},
            sfx_cues = {}
        },
        {
            ...
            duration = 24,
            ease = "linear",
            from = { x = 0, y = 0, z = 2.2, scale_x = 0.06, scale_y = 0.09, alpha = 0 },
            to = { x = 150, y = 0, z = 2.2, scale_x = 0.06, scale_y = 0.09, alpha = 1 },
            --fx_cues = {},
            sfx_cues = {}
        },
        {
            ...
            duration = 12,
            ease = "linear",
            from = { x = 0, y = 0, z = 2.4, scale_x = 0.05, scale_y = 0.05, alpha = 0.0 },
            to = { x = 0, y = 0, z = 2.4, scale_x = 0.05, scale_y = 0.05, alpha = 1.0 },
            --fx_cues = {},
            sfx_cues = {}
        },
        {
            ...
            duration = 16,
            ease = "linear",
            from = { x = 0, y = 0, z = 2.5, scale_x = 0.05, scale_y = 0.05, alpha = 0 },
            to = { x = 0, y = 0, z = 2.5, scale_x = 0.05, scale_y = 0.05, alpha = 1.0 },
            --fx_cues = {},
            sfx_cues = {}
        },
        {
            ...
            duration = 8,
            ease = "linear",
            from = { x = 0, y = 0, z = 2.4, scale_x = 0.05, scale_y = 0.05, alpha = 1.0 },
            to = { x = 0, y = 0, z = 2.4, scale_x = 0.05, scale_y = 0.05, alpha = 0.0 },
            --fx_cues = {},
            sfx_cues = {}
        },
        {
            ...
            duration = 4,
            ease = "in_quad",
            from = { x = 0, y = 0, z = 2.6, scale_x = 1, scale_y = 1, alpha = 1.0 },
            to = { x = 0, y = 30, z = 2.6, scale_x = 0.03, scale_y = 0.04, alpha = 1.0 },
            --fx_cues = {},
            sfx_cues = {}
        },
        {
